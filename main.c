...
//Aide:
//Suppression de la ligne "struc maillonSC *precedent;(sous la meme ligne avec suivant)
//Parcourir: struc maillon *aux=liste->debut;
//           aux=aux->suivant;
//Ajouter: 1) créer le maillon: malloc ==> nouveau=(struc maillonsSC)malloc(sizeof(struc maillonSC))
//         2) nouveau->suivant = apres->suivant;
//         3) apres->suivant=nouveau
//Cas particuliers: 1)Liste vide 2)Ajout/retrait en début 3)Ajout/retrait en fin
